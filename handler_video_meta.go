...
func (cfg *apiConfig) handlerVideoGet(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respondWithError(w, http.StatusInternalServerError, "Error generating presigned url for video get", err)
		return
	}
...
func (cfg *apiConfig) handlerVideosRetrieve(w http.ResponseWriter, r *http.Request) {
	...
	for i, video := range videos {
		...
		if err != nil {
			respondWithError(w, http.StatusInternalServerError, "Error generating presigned url for video retrieve", err)
			return
		}
	}
